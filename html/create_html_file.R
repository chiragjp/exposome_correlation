...
cat('<br><br>Brought to you by <a href=\'http://www.chiragjpgroup.org\'>chiragjpgroup.org</a>; globes created with <a href=\'http://circos.ca\'>Circos</a> software.</html>', file=fileout, append=T)
